...
from webnode_security.dependency import DependencyAnalyzer
from webnode_security.taint import TaintAnalyzer
from webnode_security.zap import ZapAnalyzer
from webnode_security.trivy import TrivyAnalyzer
from webnode_security.risk import RiskEngine
from webnode_security.report import ReportGenerator


class WebNodeScanner:

    def __init__(self, project_path, target_url=None):
        self.project_path = project_path
        self.target_url = target_url

        self.logger = WebNodeLogger()
