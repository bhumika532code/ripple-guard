...
WebNode Sentinel monitors your project's dependency files and warns you about vulnerable packages *the moment* they are installed — like a spell-checker, but for supply-chain security.
...
4. **Data Source**: Queries the [OSV.dev](https://osv.dev) vulnerability database (the same database powering the WebNode web dashboard)

## Commands

| Command | Description |
|---------|-------------|
| `WebNode: Scan Dependencies Now` | Manually trigger a full workspace scan |
| `WebNode: Fix Vulnerable Package` | Shows guidance on applying fixes |
...
## Part of the WebNode Ecosystem

WebNode Sentinel is the developer-facing companion to the [WebNode Web Dashboard](https://github.com/webnode) — a full-stack supply-chain security intelligence platform featuring dependency graph visualization, taint analysis simulation, SBOM generation, and blockchain-backed audit provenance.

---

**Built with ❤️ by the WebNode Security Team**
